...
从 [GitHub Releases](https://github.com/Swilder-M/cloudpc-dist/releases/latest) 下载对应平台的二进制文件：
...
交互式流程：自动生成设备标识 → 选择登录方式 → 登录 → 获取云电脑信息。配置保存到 `cloud_pc.json`。
